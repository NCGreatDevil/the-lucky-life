...
export async function onRequest(context) {
    ...
    try {
        const favList = await db.prepare(
            `SELECT uf.target_id, uf.target_type, uf.favorability, uf.updated_at,
        ...
        const results = (favList.results || []).map(f => ({
